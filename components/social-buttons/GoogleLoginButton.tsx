...
export const GoogleLoginButton: React.FC<PropsType> = ({
  onClick,
  className,
  style,
}) => {
  return (
    <button
      className={clsx(commonClasses, "border-gray-100 border", className)}
      style={{ ...style }}
      onClick={onClick}
    >
      <div className="h-full flex items-center">
        ...
        <div className="w-full align-left">Log in with Google</div>
      </div>
    </button>
  );
};
